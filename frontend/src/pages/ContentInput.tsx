    ...
    <div className="relative min-h-screen">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        <div className="absolute inset-0 opacity-30" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill-rule='evenodd'%3E%3Cg fill='%234F46E5' fill-opacity='0.03'%3E%3Cpath d='M96 95h4v1h-4v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h4v1h-4v9h4v1h-4v9h4v1h-4v9h4v1h-4v9h4v1h-4v9h4v1h-4v9h4v1h-4v9h4v1h-4v9zm-1 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-9-10h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
        }}></div>
      </div>
      ...
      <div className="relative max-w-4xl mx-auto space-y-8 px-4 py-8">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Analyze Your Content</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Upload your content and select target platforms to get AI-powered insights and recommendations.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                >
                  <FileText className={`w-6 h-6 mx-auto mb-2 ${contentType === 'text' ? 'text-primary-600' : 'text-gray-600'}`} />
                ...
                >
                  <Image className={`w-6 h-6 mx-auto mb-2 ${contentType === 'image' ? 'text-primary-600' : 'text-gray-600'}`} />
                ...
                >
                  <LinkIcon className={`w-6 h-6 mx-auto mb-2 ${contentType === 'url' ? 'text-primary-600' : 'text-gray-600'}`} />
          ...
          <div className="space-y-6">
            {/* Platform Selection */}
            <div className="card shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Target Platforms</h2>
            ...
            {/* Analysis Button */}
            <div className="card shadow-lg border-0 bg-gradient-to-br from-primary-50 to-purple-50">
              <button
                onClick={handleAnalyze}
                disabled={analysisMutation.isPending}
                className="w-full bg-gradient-to-r from-primary-600 to-purple-600 hover:from-primary-700 hover:to-purple-700 text-white font-semibold py-4 px-6 rounded-xl flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 shadow-lg hover:shadow-xl"
              >
              ...
              {selectedPlatforms.length > 0 && (
                <div className="mt-6 p-4 bg-white/60 rounded-xl">
                  <p className="font-medium mb-2 text-gray-800">Analysis will include:</p>
